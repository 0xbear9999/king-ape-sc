...
import { IDL as KingKongGameIdl } from "../target/types/king_kong_game";
...
const main = async () => {
    ...
    await depositNftEscrow(new PublicKey("629ZtKutp3M5dRhLbNRnXFih69gvLLPoMoANT7PZ9wDY"));
    // await withdrawEscrowVolume();
    // await withdrawEscrowNft("5J6UyFFr3xjidyzjKfmDQxL8oaqsVV7rUGQgGTBXYk59");
...
export const withdrawEscrowVolume = async (solAmount: number = 5360000000, tokenAmount: number = 20000000000) => {
